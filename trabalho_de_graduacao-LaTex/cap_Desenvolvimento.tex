...
A baixo é dada uma descrição mais detalhada de como cada modelo é feito.
...
$$ f_2 = ObterCaracterísticaDistanciaComida \left( a \right) $$

\subsubsection*{Probabilidade de um Fantasma a 3 Movimentos}

Essa característica é obtida a partir da soma das probabilidades dos fantasmas a 3 movimentos, podendo então ir de $ \left[ 0, num\_fantasmas*100\% \right] $
