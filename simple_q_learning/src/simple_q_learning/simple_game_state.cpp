...
{
    geometry_msgs::Pose movement = util::actionToMovement(action.action);
    int new_x = pacman_pose_.position.x + movement.position.x;
    int new_y = pacman_pose_.position.y + movement.position.y;
